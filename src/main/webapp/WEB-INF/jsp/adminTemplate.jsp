...
<div class="container mt-5">
  <h1 class="text-center mb-4">Welcome Admin: ${nomUtilisateur}</h1>
    ...
    <div class="col">
      <div class="card shadow h-100">
        <div class="card-body text-center">
          ...
          <button class="btn btn-primary w-100" onclick="location.href='${pageContext.request.contextPath}/professeurs'">
            Access
          </button>
        </div>
      </div>
    ...
    <div class="col">
      <div class="card shadow h-100">
        <div class="card-body text-center">
          ...
          <button class="btn btn-primary w-100" onclick="location.href='${pageContext.request.contextPath}/modules'">
            Access
          </button>
        </div>
      </div>
    ...
    <div class="col">
      <div class="card shadow h-100">
        <div class="card-body text-center">
          ...
          <button class="btn btn-primary w-100" onclick="location.href='${pageContext.request.contextPath}/fillieres'">
            Access
          </button>
        </div>
      </div>
    ...
    <div class="col">
      <div class="card shadow h-100">
        <div class="card-body text-center">
          ...
          <button class="btn btn-primary w-100" onclick="location.href='${pageContext.request.contextPath}/etudiants'">
            Access
          </button>
        </div>
      </div>
